...
- [ ] no diff table, seems too limting, rather interactions ... then diff
...
- [ ] Do some sort of approval process
- [ ] handle overlapping uploads, if you contribute something once, and upload again how to handle
- [ ] how to handle if person does multiple commits in a session, or not, it'd be cool to reference commit 